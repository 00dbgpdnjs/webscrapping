...
# << csv 파일 [or excel] 의 첫번쨰 줄에 title[각 수치가 무엇인지] 추가 >>
...
# >> ["N", "종목명", "현재가", ...]
# 단어 사이마다 "/t" 으로 구분되어 있음. split에 기준["/t"]를 줘서 "/t"로 구분되있는 단어들을 리스트에 담음 writerow에는 리스트만 넣을수 있기 때문에
title = "N	종목명	현재가	전일비	등락률	액면가	시가총액	상장주식수	외국인비율	거래량	PER	ROE".split("/t")
# print(type(title))
writer.writerow(title)  # ❗❗ KEY CODE ❗❗
